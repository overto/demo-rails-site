class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :quantity_on_hand, :selling_price, :cost_of_product, :shipping_weight, :product_thumbnail_image_url, :product_fullsize_image_url)
    end
end
