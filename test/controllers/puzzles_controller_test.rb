...
class PuzzlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create puzzle" do
    assert_difference('Puzzle.count') do
      post puzzles_url, params: { puzzle: { puzzle_name: @puzzle.puzzle_name, word_list: @puzzle.word_list } }
    end
  ...
  test "should update puzzle" do
    patch puzzle_url(@puzzle), params: { puzzle: { puzzle_name: @puzzle.puzzle_name, word_list: @puzzle.word_list } }
